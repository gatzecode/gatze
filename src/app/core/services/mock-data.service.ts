  ...
  getInitialAccounts(): Account[] {
    return [
      ...
      },
      {
        ...
        name: 'LÓPEZ RAMÍREZ CARLOS ALBERTO',
        accountNumber: '1000000005',
      },
      {
        card: '4152313471829333',
        name: 'HERNÁNDEZ GONZÁLEZ LAURA PATRICIA',
      ...
      { card: '4152313471829341', name: 'SÁNCHEZ PÉREZ JORGE LUIS', accountNumber: '1000000007' },
      {
        ...
        name: 'GONZÁLEZ MARTÍNEZ DIANA ELIZABETH',
        accountNumber: '1000000008',
      },
      {
        card: '4152313471829366',
        name: 'PÉREZ TORRES ROBERTO CARLOS',
      ...
      { card: '4152313471829374', name: 'TORRES CRUZ MARTHA ALICIA', accountNumber: '1000000010' },
      {
        ...
        name: 'RAMÍREZ FLORES MIGUEL ÁNGEL',
        accountNumber: '1000000011',
      },
      {
        card: '4152313471829390',
        name: 'FLORES MORALES ANDREA SOFÍA',
        accountNumber: '1000000012',
      },
      {
        card: '4152313471829408',
        name: 'MORALES JIMÉNEZ FRANCISCO JAVIER',
        accountNumber: '1000000013',
      },
      {
        card: '4152313471829416',
        name: 'JIMÉNEZ VARGAS GABRIELA ALEJANDRA',
        accountNumber: '1000000014',
      },
      {
        card: '4152313471829424',
        name: 'VARGAS CASTILLO DANIEL EDUARDO',
